...
/* harmony default export */ const routes = ([{path:'/docubase/blog',component:ComponentCreator('/docubase/blog','2f6'),exact:true},{path:'/docubase/blog/archive',component:ComponentCreator('/docubase/blog/archive','4c8'),exact:true},{path:'/docubase/blog/first-blog-post',component:ComponentCreator('/docubase/blog/first-blog-post','310'),exact:true},{path:'/docubase/blog/long-blog-post',component:ComponentCreator('/docubase/blog/long-blog-post','834'),exact:true},{path:'/docubase/blog/mdx-blog-post',component:ComponentCreator('/docubase/blog/mdx-blog-post','c9a'),exact:true},{path:'/docubase/blog/tags',component:ComponentCreator('/docubase/blog/tags','653'),exact:true},{path:'/docubase/blog/tags',component:ComponentCreator('/docubase/blog/tags','927'),exact:true},{path:'/docubase/blog/tags/docusaurus',component:ComponentCreator('/docubase/blog/tags/docusaurus','9d2'),exact:true},{path:'/docubase/blog/tags/hello',component:ComponentCreator('/docubase/blog/tags/hello','b03'),exact:true},{path:'/docubase/blog/tags/hola',component:ComponentCreator('/docubase/blog/tags/hola','b34'),exact:true},{path:'/docubase/blog/tags/is',component:ComponentCreator('/docubase/blog/tags/is','6b8'),exact:true},{path:'/docubase/blog/tags/the',component:ComponentCreator('/docubase/blog/tags/the','77d'),exact:true},{path:'/docubase/blog/tags/this',component:ComponentCreator('/docubase/blog/tags/this','b05'),exact:true},{path:'/docubase/blog/tags/way',component:ComponentCreator('/docubase/blog/tags/way','cc6'),exact:true},{path:'/docubase/blog/welcome',component:ComponentCreator('/docubase/blog/welcome','30b'),exact:true},{path:'/docubase/markdown-page',component:ComponentCreator('/docubase/markdown-page','eea'),exact:true},{path:'/docubase/docs',component:ComponentCreator('/docubase/docs','8ab'),routes:[{path:'/docubase/docs/category/tutorial---basics',component:ComponentCreator('/docubase/docs/category/tutorial---basics','c2a'),exact:true,sidebar:"tutorialSidebar"},{path:'/docubase/docs/tutorial-basics/congratulations',component:ComponentCreator('/docubase/docs/tutorial-basics/congratulations','b0e'),exact:true,sidebar:"tutorialSidebar"}]},{path:'/docubase/',component:ComponentCreator('/docubase/','7fa'),exact:true},{path:'*',component:ComponentCreator('*')}]);
...
const globalData_namespaceObject = JSON.parse('{"docusaurus-plugin-content-docs":{"default":{"path":"/docubase/docs","versions":[{"name":"current","label":"Next","isLast":true,"path":"/docubase/docs","mainDocId":"tutorial-basics/congratulations","docs":[{"id":"tutorial-basics/congratulations","path":"/docubase/docs/tutorial-basics/congratulations","sidebar":"tutorialSidebar"},{"id":"/category/tutorial---basics","path":"/docubase/docs/category/tutorial---basics","sidebar":"tutorialSidebar"}],"draftIds":[],"sidebars":{"tutorialSidebar":{"link":{"path":"/docubase/docs/category/tutorial---basics","label":"Tutorial - Basics"}}}}],"breadcrumbs":true}}}');
