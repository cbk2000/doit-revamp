...
const globalData_namespaceObject = JSON.parse('{"docusaurus-plugin-content-docs":{"default":{"path":"/doit-revamp/docs","versions":[{"name":"current","label":"Next","isLast":true,"path":"/doit-revamp/docs","mainDocId":"template/template","docs":[{"id":"template/template","path":"/doit-revamp/docs/template/","sidebar":"tutorialSidebar"},{"id":"template/template_no_image","path":"/doit-revamp/docs/template/template_no_image","sidebar":"tutorialSidebar"},{"id":"tutorial-basics/congratulations","path":"/doit-revamp/docs/tutorial-basics/congratulations","sidebar":"tutorialSidebar"},{"id":"virtualbox/debian-guest-preparation","path":"/doit-revamp/docs/virtualbox/debian-guest-preparation","sidebar":"tutorialSidebar"},{"id":"virtualbox/installing-vbox-on-windows","path":"/doit-revamp/docs/virtualbox/installing-vbox-on-windows","sidebar":"tutorialSidebar"},{"id":"/category/tutorial---basics","path":"/doit-revamp/docs/category/tutorial---basics","sidebar":"tutorialSidebar"},{"id":"/category/virtual-box","path":"/doit-revamp/docs/category/virtual-box","sidebar":"tutorialSidebar"}],"draftIds":[],"sidebars":{"tutorialSidebar":{"link":{"path":"/doit-revamp/docs/template/","label":"Title Here"}}}}],"breadcrumbs":true}}}');
